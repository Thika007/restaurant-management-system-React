...
BEGIN
    CREATE TABLE [dbo].[Items] (
        ...
        [minQty] DECIMAL(18, 3) NULL,     -- For Grocery Items: minimum quantity threshold for stock tracking
        [maxQty] DECIMAL(18, 3) NULL,     -- For Grocery Items: maximum quantity threshold for stock tracking
        [createdAt] DATETIME DEFAULT GETDATE(),
        [updatedAt] DATETIME DEFAULT GETDATE(),
